class Combat:
    def __init__(self, player, monster):
        ...
        self.turncount(player, monster)
        #fightplayerturn(player, monster)

    def turncount(self, player, monster):
        ...
        if player.turncounter >= 100:
            ...
            self.playerturn(player,monster)
    ...
    def playerturn(self, player, monster):
        self.activateonplayerturn(player, monster)
        ...
        if option == "attack" or option == '1':
            ...
            self.playerdefend(player, monster, 2)
    ...
    def playerattack(self, player, monster):
        ...
        self.fightcheck(player, monster)

    def playerdefend(self, player, monster, counter):
        pass
    ...
    def fightcheck(self, player, monster):
        if player.health <= 0:
            print("You Lose")
            ##gameover
        if monster.health <= 0:
